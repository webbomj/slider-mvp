...
var _controller = require("./demo-page/controller");
...
},{"./demo-page/controller":"k3wdx","./slider/slider":"fxfxT","jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k3wdx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
    ...
    createControlPanel = ()=>{
        ...
        for(const key in this.state){
            ...
            if (this.numberInputs.includes(key)) {
                element = this.createControlItem((0, _interfaces.ICreateControlPanelProps).number, key, this.state[key]);
                controlRight.append(element);
            } else {
                element = this.createControlItem((0, _interfaces.ICreateControlPanelProps).checkbox, key, this.state[key]);
...
let ICreateControlPanelProps;
(function(ICreateControlPanelProps1) {
    ICreateControlPanelProps1["number"] = "number";
    ICreateControlPanelProps1["checkbox"] = "checkbox";
})(ICreateControlPanelProps || (ICreateControlPanelProps = {}));
...
},{}],"d3tFQ":[function() {},{}],"fxfxT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}]},["iJYvl","h7u1C"], "h7u1C", "parcelRequire8bd1")
